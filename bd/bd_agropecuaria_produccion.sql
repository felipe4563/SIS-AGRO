-- ============================================================
--  SIS-AGRO — Base de datos PRODUCCIÓN
--  Solo estructura + super_admin + planes + permisos
--  Sin empresas, usuarios, ni datos de prueba
-- ============================================================
...
-- CAMBIAR correo y contrasena antes de subir a produccion
INSERT INTO `super_admin` (`id_admin`, `nombre`, `correo`, `contrasena`, `ultimo_acceso`, `activo`, `creado_en`) VALUES
(1, 'Administrador SIS-AGRO', 'admin@sisagro.bo', '$2b$10$d4lbs5r6ZzArqhXcfdcyAO8ZyGbZKkJWErP1QhNC1weRpYY/aUmQi', NULL, 1, NOW());
...
ALTER TABLE `apertura_cierre_caja`  MODIFY `id_apertura`      int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `caja`                  MODIFY `id_caja`           int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `categoria_movimiento`  MODIFY `id_categoria`      int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `clasificacion_producto`MODIFY `id_clasificacion`  int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `cliente`               MODIFY `id_cliente`        int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `compra`                MODIFY `id_compra`         int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `conversion_unidad`     MODIFY `id_conversion`     int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `detalle_compra`        MODIFY `id_detalle_compra` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `detalle_venta`         MODIFY `id_detalle_venta`  int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `empresa`               MODIFY `id_empresa`        int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `lote`                  MODIFY `id_lote`           int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `marca`                 MODIFY `id_marca`          int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `movimiento`            MODIFY `id_movimiento`     int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `movimiento_almacen`    MODIFY `id_movimiento`     int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `pago_compra`           MODIFY `id_pago_compra`    int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `pago_suscripcion`      MODIFY `id_pago`           int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `pago_venta`            MODIFY `id_pago_venta`     int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `permiso`               MODIFY `id_permiso`        int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
ALTER TABLE `plan`                  MODIFY `id_plan`           int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
ALTER TABLE `producto`              MODIFY `id_producto`       int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `producto_fraccion`     MODIFY `id_prod_fraccion`  int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `proveedor`             MODIFY `id_proveedor`      int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `rol`                   MODIFY `id_rol`            int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `sucursal`              MODIFY `id_sucursal`       int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `super_admin`           MODIFY `id_admin`          int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
ALTER TABLE `suscripcion`           MODIFY `id_suscripcion`    int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `traslado`              MODIFY `id_traslado`       int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `unidad_medida`         MODIFY `id_unidad`         int(11) NOT NULL AUTO_INCREMENT;
